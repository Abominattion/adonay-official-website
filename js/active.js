(function ($) {
    ...
    if ($.fn.imagesLoaded) {
        $('.metal4all-albums').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.metal4all-albums').isotope({
    ...
    $('.hero-slides-content a[href^="#"]').on('click', function(e) {
        e.preventDefault();
